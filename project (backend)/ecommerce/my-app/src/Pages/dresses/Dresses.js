...
const Heels = () => {
    ...
    useEffect(() => {
        if (items.length === 0) {
            axios.post('http://localhost:5000/getalldresses', {})
                .then(response => {
    ...
    return (
        <>
            <h1 className="pt-10 text-center font-bold text-4xl">Womens Fashion</h1>
                    ...
                    return (
                        <div key={_id} className="card">
                            ...
                            <div className="button-row">
                                ...
                                <button className="buy-now-btn" onClick={() => handleBuyNow(_id,"alldresses")}>
                                    Buy Now
                                </button>
                            </div>
