  ...
  return (
    <div className="Appp">
      ...
      <video autoPlay loop muted id="video">
        <source src="/Assets/mens.mp4" type="video/mp4" />
      </video>
    </div><br/><br/>
      ...
      <main className="Appp-mainn">
        <div className="cardd">
          <img src="/Assets/zaramen2.jpg" alt="Minimalist Outfit" className="cardd-imagee" />
          <h5>Minimalist Outfit with Charles & Keith Bag</h5>
        </div>
        <div className="cardd">
          <img src="/Assets/us.jpg" alt="Louis Vuitton Ankle Boots" className="cardd-imagee" />
          <h5>Louis Vuitton Pillow Comfort Ankle Boots</h5>
        </div>
        <div className="cardd">
          <img src="/Assets/mongo.jpg" alt="Favourite Nude Lipsticks" className="cardd-imagee" />
          <h5>Mongo man summer style inspriation</h5>
        </div>
        <div className="cardd">
          <img src="/Assets/h&mmen.jpg" alt="Favourite Bags" className="cardd-imagee" />
          <h5>sharper look withclassic and contemporary from H&M</h5>
        </div>
        <div className="cardd">
          <img src="/Assets/calvin1.jpg" alt="Packing Tips" className="cardd-imagee" />
      ...
      <img src="/Assets/m.jpg" alt="Favourite Bags" className="cardd-imagee1" />
  <img src="/Assets/polo.jpg" alt="Favourite Bags" className="cardd-imagee1" />
  <img src="/Assets/z.jpg"alt="Favourite Bags" className="cardd-imagee1" />
  <img src="/Assets/c.jpg" alt="Favourite Bags" className="cardd-imagee1" />
  <img src="/Assets/hm.jpg" alt="Favourite Bags" className="cardd-imagee1" />
